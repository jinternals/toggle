...
public class ToggleConditionTest {
    ...
    public void setUp() throws Exception {
        ...
        attributes.put("feature", "some-feature");
        ...
        when(toggleDecider.isToggleDefined("some-feature")).thenReturn(true);
        when(toggleDecider.isToggleOn("some-feature")).thenReturn(true);
    ...
    public void shouldReturnFalseIfFeatureToggleAnnotationIsPresentAndExpectedToBeFalseAndIsFalse() {
        ...
        when(toggleDecider.isToggleOn("some-feature")).thenReturn(false);
    ...
    public void shouldReturnFalseIfFeatureToggleIsNotDefined() {
        ...
        when(toggleDecider.isToggleDefined("some-feature")).thenReturn(false);
